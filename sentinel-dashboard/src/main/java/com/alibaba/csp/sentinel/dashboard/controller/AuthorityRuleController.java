...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.authority.FlowRuleAuthorityNacosProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.authority.FlowRuleAuthorityNacosPublisher;
...
public class AuthorityRuleController {
    ...
    @Autowired
    @Qualifier("flowRuleAuthorityNacosProvider")
    private DynamicRuleProvider<List<AuthorityRuleEntity>> ruleProvider;

    @Autowired
    @Qualifier("flowRuleAuthorityNacosPublisher")
