...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.degrade.FlowRuleDegradeNacosProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.degrade.FlowRuleDegradeNacosPublisher;
...
public class DegradeController {
    ...
    @Autowired
    @Qualifier("flowRuleDegradeNacosProvider")
    private DynamicRuleProvider<List<DegradeRuleEntity>> ruleProvider;

    @Autowired
    @Qualifier("flowRuleDegradeNacosPublisher")
