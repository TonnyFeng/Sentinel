...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.flow.FlowRuleFlowNacosProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.flow.FlowRuleFlowNacosPublisher;
...
public class FlowControllerV1 {
    ...
    @Autowired
    @Qualifier("flowRuleFlowNacosProvider")
    private DynamicRuleProvider<List<FlowRuleEntity>> ruleProvider;

    @Autowired
    @Qualifier("flowRuleFlowNacosPublisher")
    ...
    public Result<FlowRuleEntity> apiAddFlowRule(@RequestBody FlowRuleEntity entity) {
        ...
        try {
            ...
            publishRules( entity.getApp() ).get(5000, TimeUnit.MILLISECONDS);
