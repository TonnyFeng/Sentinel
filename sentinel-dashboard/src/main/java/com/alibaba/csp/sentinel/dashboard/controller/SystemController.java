...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.system.FlowRuleSystemNacosProvider;
import com.alibaba.csp.sentinel.dashboard.rule.nacos.system.FlowRuleSystemNacosPublisher;
...
public class SystemController {
    ...
    @Autowired
    @Qualifier("flowRuleSystemNacosProvider")
    private DynamicRuleProvider<List<SystemRuleEntity>> ruleProvider;

    @Autowired
    @Qualifier("flowRuleSystemNacosPublisher")
